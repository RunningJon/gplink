...
6.  Define source configurations in $GPHOME/connections/ 
7.  Define external table names and columns in $GPHOME/tables/
8.  Define SQL statements to execute in the source in $GPHOME/sql/
