...
{
	public static String createTable(Connection conn, String hostName, String targetTable, String sourceConfig, String sql, String targetConfig) throws SQLException
	{
		try
		{
			String tableName = "";
			String columns = "";
			Integer myPort = Listener.getPort(conn, targetConfig);
			if (GPLink.debug)
			...
			strSQL += "(" + columns + ")\n";
			strSQL += "LOCATION ('gpfdist://" + hostName + ":" + myPort + "/" + sourceConfig + "+" + sql + "#transform=gplink')\n";
